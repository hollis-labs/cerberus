...
func TestBuiltinEffectClassification(t *testing.T) {
	want := map[string]contract.Effect{
		...
		"namecheap.get_dns_record_set": contract.EffectRead, "namecheap.set_dns_record_set": contract.EffectWrite,
		"namecheap.list_domains": contract.EffectRead, "namecheap.get_domain_status": contract.EffectRead,
		"namecheap.list_dns_records": contract.EffectRead, "namecheap.set_custom_nameservers": contract.EffectWrite,
