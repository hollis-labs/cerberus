...
func AllTools(client cerbapi.Client) []Tool {
	tools := []Tool{
		...
		NewCerberusCloudflareZonesTool(client),
		NewCerberusCloudflareZoneCreateTool(client),
		NewCerberusCloudflareDNSListTool(client),
		NewCerberusCloudflareDNSCreateTool(client),
		NewCerberusCloudflareDNSDeleteTool(client),
