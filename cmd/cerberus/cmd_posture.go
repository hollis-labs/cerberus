...
var hostWide = []hostWideRow{
	{Switch: "plugin install", Secure: "review summary and a confirmation on a terminal", Permissive: "summary printed; --yes skips the confirmation"},
	{Switch: "changed plugin", Secure: "refused until re-reviewed", Permissive: "loaded, with a warning and an audit record"},
